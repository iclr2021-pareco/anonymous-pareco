...
def conv_bn(inp, oup, stride, conv_layer=MaskConv2d, norm_layer=nn.BatchNorm2d, nlin_layer=nn.ReLU):
...
def conv_1x1_bn(inp, oup, conv_layer=MaskConv2d, norm_layer=nn.BatchNorm2d, nlin_layer=nn.ReLU):
    return nn.Sequential(
...
if __name__ == '__main__':
    ...
    flops, params = profile(net, inputs=(img, ), custom_ops={MaskConv2d: count_convNd})
    # print(flops)
    # print(params)
